...
For missing values, we use the mice package, predictive mean matching method (2 data sets, 10 iterations).
...
This plot contains 2 parts: a before/after histogram, and before/after linear density plots. Overall the imputation didn't affect the character of the data very much. Most of the new weight was added above the mean/median (they're close together), so the immputed mean/median ticked upwards slightly. And since most of the added weight was near the mean/median, the standard deviation shows a bit of a decrease.
